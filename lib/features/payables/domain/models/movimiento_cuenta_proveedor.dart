...
/// Espejo de MovimientoCuentaProveedorResumen en el backend — Tipo llega
/// como string ("Cargo"/"Abono") porque el backend no serializa enums
/// como número acá (usa ToString(), ver ObtenerCuentaPorPagarQuery).
class MovimientoCuentaProveedor {
  const MovimientoCuentaProveedor({
    required this.id,
    required this.tipo,
    required this.monto,
  ...
  factory MovimientoCuentaProveedor.fromJson(Map<String, dynamic> json) => MovimientoCuentaProveedor(
