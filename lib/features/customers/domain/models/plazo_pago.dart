...
/// término de pago del catálogo (ej. "Contado", "30 días", "30-60-90 días").
/// Catálogos separados por Bounded Context — este modelo se usa tanto para
/// Clientes como para Proveedores (misma forma, distinto endpoint), nunca
/// mezclados.
class PlazoPago {
