...
/// Mantención del catálogo de Plazos de Pago de Proveedores — usado desde
/// ProveedorFormDialog (dropdown de Plazos activos). Un Plazo desactivado
/// sigue existiendo para quien ya lo tiene asignado, solo desaparece del
/// selector de alta/edición nuevas.
class PlazosPagoProveedorScreen extends ConsumerWidget {
  const PlazosPagoProveedorScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final estado = ref.watch(plazosPagoProveedorProvider);
    final controller = ref.read(plazosPagoProveedorProvider.notifier);
        ...
        trailing: Row(
          ...
          children: [
            Chip(
              ...
              backgroundColor:
                  plazo.activo ? Theme.of(context).colorScheme.primaryContainer : Theme.of(context).colorScheme.surfaceVariant,
            ),
