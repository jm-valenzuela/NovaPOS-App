...
- Del diseño objetivo del POS: descuentos por línea, "Cotización" (venta sin confirmar) y escaneo de código de barras por cámara — ninguno tiene soporte en el backend todavía.
